...
Preprocessing steps include handling missing values, converting categorical features, and scaling numerical features. Refer to the notebooks for details.
...
- `titanic_analysis.ipynb`: Jupyter notebook containing the main analysis
